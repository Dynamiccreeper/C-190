...
//City moves backward when up arrow keys is pressed
//city secne moves forward when down arrow key is pressed
//refer to the fligth simulation
//increse the speed when acc is pressed on click 
//decrese the speed when the break is clicked
//when the steering is turn the 
